...
def main():
    ...
    # Добавляем обработчики - ИСПРАВЛЕННАЯ ВЕРСИЯ
    app.add_handler(MessageHandler(
        filters.ChatType.PRIVATE & filters.TEXT & filters.User(user_id=YOUR_USER_ID), 
        copy_to_channel
    ))
    app.add_handler(MessageHandler(
        filters.ChatType.PRIVATE & filters.PHOTO & filters.User(user_id=YOUR_USER_ID), 
        copy_to_channel
    ))
    app.add_handler(MessageHandler(
        filters.ChatType.PRIVATE & filters.VIDEO & filters.User(user_id=YOUR_USER_ID), 
        copy_to_channel
    ))
    app.add_handler(MessageHandler(
        filters.ChatType.PRIVATE & filters.Document.ALL & filters.User(user_id=YOUR_USER_ID), 
        copy_to_channel
    ))
    app.add_handler(MessageHandler(
        filters.ChatType.PRIVATE & filters.VOICE & filters.User(user_id=YOUR_USER_ID), 
        copy_to_channel
    ))
